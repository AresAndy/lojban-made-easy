...
<figure>
	<img src="https://mw.lojban.org/images/thumb/3/31/lo_kroto_noi_se_carnygau.svg/96px-lo_kroto_noi_se_carnygau.svg.png" alt="le najgenja">
	<figcaption>
	<b>le najgenja</b><br/>
	<i>the carrot</i>
	</figcaption>
...
> _Three carrots are heavy._

Does it mean that each carrot is heavy or does it mean that they are heavy if taken together?

In Lojban we can easily distinguish between these two cases:

> **le ci najgenja cu tilju**

> _Each of the three carrots is heavy._

<!-- -->

> **lei ci najgenja cu tilju**

> _Three carrots are heavy in total._

> (so that every carrot might be light but together they are heavy)
...
> **le ci najgenja cu grake li 60**

> _Each of the three carrots weigh 60 grams._

<!-- -->

> **lei ci najgenja cu grake li 60**
...
In the examples above _I suggest the pub._ most likely implies going to the pub and _I want an apple._ implies eating it.
...
> _I want something about an apple (probably, eating it, maybe chewing it, licking it, throwing it at your friend etc.)._
...
> — _In what country do you live?_
...
> — _How do you feel (emotionally)?_
...
.e'ei
: interjection: _Come on!_ (encourgament, instigation, provokation). Not an official word
...
> **.i mi venfu do .e ji'a le cmalu gerku pe do**
...
<table style="font-size: 0.618rem;">
<tbody><tr>
...
<tr>
<td rowspan="3"> Attachment to situation
</td>
...
<td><b>.a'i cu'i</b><br/>no special effot
</td>
<td><b>.a'o cu'i</b><br/>&nbsp;
</td>
...
<td>The question mark is used here for stylistic purposes.
</td></tr>
<tr valign="top">
<td><b>mi kanro<br/>.i mi ca tadni la .lojban.<br/>.i mi troci le ka tavla do</b>
</td>
<td><i>I'm healthy.<br/>I now study Lojban.<br/>I'm trying to talk to you.</i>
</td>
<td>
<dl><dd><b>kanro</b> = <i>to be healthy</i></dd>
<dd><b>tadni</b> = <i>to study … (something)</i></dd>
<dd><b>troci</b> = <i>to try … (to do something)</i></dd>
<dd><b>tavla</b> = <i>to talk [to someone]</i></dd></dl>
</td></tr>
<tr valign="top">
<td><b>zabna<br/>.i ma tcima ca le bavlamdei?</b>
</td>
<td><i>Good.<br/>What will be the weather tomorrow?</i>
</td>
<td>
<dl><dd><b>zabna</b> = <i>to be nice, cool</i></dd>
<dd><b>tcima</b> = <i>is the weather</i></dd>
<dd><b>ca</b> = <i>at (some time)</i></dd>
<dd><b>le bavlamdei</b> = <i>tomorrow day</i></dd></dl>
</td></tr>
<tr valign="top">
<td><b>mi na ku djuno<br/>.i le solri sei mi pacna</b>
</td>
<td><i>I don't know.<br/>It'll be sunny, I hope.</i>
</td>
<td>
<dl><dd><b>djuno</b> = <i>to know (fact)</i></dd>
<dd><b>le solri</b> = <i>the sun</i></dd>
<dd>Note that <b>le solri cu tcima</b> (literally <i>the sun is the weather</i>) is the way of using <b>tcima</b> in Lojban.</dd>
<dd><b>sei</b> = <i>comment starts</i></dd>
<dd><b>pacna</b> = <i>to hope (for some event)</i></dd></dl>
</td></tr>
<tr valign="top">
<td><b>mi jimpe</b>
</td>
...
> _Yes. It is an apple. The apple is red._
...
Notice that we can both say _see the form of the apple_ and _see the apple_.
...
> — _You hear a sound of what?_

> — **le plise poi co'i farlu**

> — _The apple that has fallen down._
...
> **le nanmu pu cadzu tai le nu ri bevri su'o da poi tilju**
...
> **mi nelci le'e pesxu ne se mau le'e ladru**
...
> **le'e pesxu cu zmadu le'e ladru le ka mi nelci**

> _I like jam more than milk._

> `Jam exceeds milk in how much I like it.`
...
- _any_ is used when providing choice and translated as **ro da**:
	...
	> **ro da poi do nelci zo'u mi e'ande do le ka citka da**
	...
	.e'ande
	: x1 allows x2 to do x3 (property of x2)
...
> **le ctuca pu posydu'a le jemna la .ben. ki'u le nu by. pu zabna gunka**

> _The teacher gave the gem as a present to Ben because he worked nice._
...
> _The teacher gave the gem as a present to Ben motivated by his work nice._
...
> — _Will you drink tea or coffee?_
...
> **na .e** — _The second one (coffee)_ (not the first but the second one is chosen)\_
